...
// Option configures Redis websocket broker/presence provider.
...
func Hubs(names ...string) Option {
	return func(options *options) { options.hubs = append([]string(nil), names...) }
}
func Channel(value string) Option { return func(options *options) { options.channel = value } }
func PresencePrefix(value string) Option {
	return func(options *options) { options.presencePrefix = value }
}
