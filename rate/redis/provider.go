...
func (provider *provider) Register(ctx runaprovider.Context) error {
	...
	registry.RegisterDriver(opts.driverName, newDriver(client, opts, ownsClient))
	return nil
}
...
func defaultOptions() options {
	return options{driverName: defaultDriverName, useName: defaultSharedName, addr: defaultRedisAddr, prefix: "runa:rate:"}
}
